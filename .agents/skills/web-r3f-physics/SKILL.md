...
description: React Three Fiber physics workflows for Codex. Use when integrating @react-three/rapier, RigidBody, colliders, collision events, joints, or physics-driven scene interactions in R3F.
---

# R3F Physics

Open `advanced/scaling-performance` and the Rapier package docs after checking `.agents/skills/web-r3f-fundamentals/references/llm.txt`.
