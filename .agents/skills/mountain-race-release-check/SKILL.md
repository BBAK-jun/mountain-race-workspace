...
description: Verify release readiness for the mountain race workspace. Use before merging, demoing, or deploying changes that affect UI, gameplay, API, tooling, Cursor config, Codex config, CI, or other project-level configuration.
---
...
1. List the surfaces touched: UI, gameplay, API, tooling, Cursor config, Codex config, CI.
...
- Agent config: rules are scoped cleanly, skills are non-duplicative, prompts stay specialized, hooks stay safe
