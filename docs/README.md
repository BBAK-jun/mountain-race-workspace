...
2. [mountain-race-technical-prd.md](./mountain-race-technical-prd.md)
3. [mountain-race-mvp-guide.md](./mountain-race-mvp-guide.md)
4. [deployment.md](./deployment.md)

## 문서 역할

- `mountain-race-product-prd.md`: 게임의 목적, 사용자 흐름, 제품 범위, 연출 톤을 정의한다.
- `mountain-race-technical-prd.md`: 상태 구조, 시스템 설계, 게임 루프, 화면 구현 방식의 기술 기준이다.
- `mountain-race-mvp-guide.md`: 현재 레포 구조에 맞춘 구현 순서, 작업 분배, MVP 의사결정을 정리한 개발 시작 가이드다.
