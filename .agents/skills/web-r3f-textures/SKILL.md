...
description: React Three Fiber texture workflows for Codex. Use when loading images with useTexture or useLoader, configuring repeats and filters, applying PBR texture sets, or working with environment maps and texture color space.
---

# R3F Textures

Open `tutorials/loading-textures`, `api/objects`, and `tutorials/v9-migration-guide` from `.agents/skills/web-r3f-fundamentals/references/llm.txt` before texture-heavy work.
