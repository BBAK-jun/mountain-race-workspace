...
description: React Three Fiber asset loading patterns for Codex. Use when loading GLTF, FBX, OBJ, HDRI, or texture assets with useGLTF, useLoader, Suspense, preloading, and asset reuse patterns.
---

# R3F Loaders

Open `tutorials/loading-models`, `tutorials/loading-textures`, `api/hooks`, and `advanced/scaling-performance` from `.agents/skills/web-r3f-fundamentals/references/llm.txt` first.
