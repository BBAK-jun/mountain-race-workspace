...
description: React Three Fiber material workflows for Codex. Use when choosing mesh materials, applying PBR settings, wiring texture maps, using Drei material helpers, or refactoring mesh styling in scene components.
---

# R3F Materials

Open `api/objects`, `tutorials/loading-textures`, and any shader-specific route from `.agents/skills/web-r3f-fundamentals/references/llm.txt` as needed.
