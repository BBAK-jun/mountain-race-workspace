...
description: React Three Fiber fundamentals for Codex. Use when setting up Canvas, useFrame, useThree, JSX scene elements, refs, or converting imperative three.js patterns into declarative React scene components.
---
