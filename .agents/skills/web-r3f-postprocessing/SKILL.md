...
description: React Three Fiber post-processing workflows for Codex. Use when adding bloom, DOF, noise, vignette, chromatic aberration, SSAO, or other screen-space effects with @react-three/postprocessing.
---

# R3F Post-Processing

Open `advanced/scaling-performance` and the post-processing package docs after checking `.agents/skills/web-r3f-fundamentals/references/llm.txt`.
