...
description: React Three Fiber lighting workflows for Codex. Use when adding light rigs, configuring shadows, using Environment-based lighting, or balancing lighting quality and performance in R3F scenes.
---

# R3F Lighting

Open `api/canvas`, `advanced/scaling-performance`, and relevant environment-texture routes from `.agents/skills/web-r3f-fundamentals/references/llm.txt` first.
