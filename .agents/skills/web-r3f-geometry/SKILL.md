...
description: React Three Fiber geometry workflows for Codex. Use when creating mesh shapes, custom BufferGeometry, path-based geometry, point clouds, lines, or instanced geometry for scene performance.
---

# R3F Geometry

Open `api/objects` and `advanced/scaling-performance` from `.agents/skills/web-r3f-fundamentals/references/llm.txt` first.
