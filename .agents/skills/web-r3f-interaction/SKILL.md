...
description: React Three Fiber interaction patterns for Codex. Use when handling pointer events, selection, dragging, controls, raycasting behavior, or interactive camera and mesh responses in 3D scenes.
---

# R3F Interaction

Open `tutorials/events-and-interaction` and `api/events` from `.agents/skills/web-r3f-fundamentals/references/llm.txt` first.
